//! # precompute
//! 
//! This module provides methods for computing static electric and magnetic fields for magnetohydrodynamic simulations.
//! These fields are based on charges and magnets positioned in the simulation.
